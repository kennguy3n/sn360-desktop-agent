...
| `sda-device-control` | ShieldNet Device Control router — `SignedActionJob` validation, `Finding` / `Recommendation` / `ActionResult` / `EvidenceRecord` schemas (Phase 1; default off) |
