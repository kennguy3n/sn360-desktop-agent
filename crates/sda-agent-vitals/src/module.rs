...
//!    (default 60s — `Priority::Low` per ARCHITECTURE.md § 7.3).
...
//! invariant from ARCHITECTURE.md § 10).
...
/// Default cadence for the heartbeat (ARCHITECTURE.md § 7.3).
...
mod tests {
    ...
    fn default_heartbeat_interval_matches_arch_md() {
        // ARCHITECTURE.md § 7.3 lists AgentVitals as Priority::Low
